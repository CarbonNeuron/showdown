...
LANGUAGES = {
    ...
    "dotnet9":      {"ext": "cs",     "name": "C# (.NET 9)",    "compiled": True},
    "dotnet10":     {"ext": "cs",     "name": "C# (.NET 10)",   "compiled": True},
    "dotnet9-aot":  {"ext": "cs",     "name": "C# (.NET 9 AOT)","compiled": True},
    "dotnet10-aot": {"ext": "cs",     "name": "C# (.NET 10 AOT)","compiled": True},
